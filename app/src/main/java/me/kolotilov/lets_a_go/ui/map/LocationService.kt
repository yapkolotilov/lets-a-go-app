...
//region Другие реализации

//class LibraryLocationServiceImpl(
//    context: Context
//) : LocationService {
//
...
//}
//
//private class LibraryLocationServiceImpl(
//    context: Context
//) : LocationService {
//
//    private var callback: (Location) -> Unit = {}
...
//    }
//
//    private val locationManager = com.yayandroid.locationmanager.LocationManager.Builder(context)
